...
import useWindowDimensions from "../Body/WindowsDimesnionHook";
...
export default function Navbar() {
  ...
  const onClickDropdownCardStyle = {
    display: "none",
  };
  const clickedStyle = {
    border: "solid #002f34",
  ...
  return (
    <React.Fragment>
      <nav>
        <ul>
          <div className={classes.screenSize1}>Width: {width}</div>
          <div className={classes.screenSize2}> x Height: {height}</div>
          ...
          <div className={classes.icon}>
            <BiSearch className={classes.searchIcon}></BiSearch>
          </div>
          {!isLoggedin && (
